...
/*
g++ -Wall -I../extern/nano_geo_matrix/include -I../extern/nano_geo_matrix/modules -I/usr/local/include -I/usr/include/eigen3 -L/usr/local/lib ../src/anl_time.cxx -o ../bin/anl -lgsl -lgslcblas -lm -larmadillo
*/
...
int main(int argc, char** argv){
    ...
    alfa<<real(alph)<<" "<<imag(alph)<<" "<<real(alph_anl)<<" "<<imag(alph_anl)<<" "<<real(eps2)<<" "<<imag(eps2)<<endl;    
  return 0;
  }
