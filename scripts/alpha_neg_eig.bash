...
read a Dome ome21 G omemi omema mtl mdl atv sol E0 < "$infile"
...
{
    echo "$a $Dome $omeG $G $wideomi $wideoma $mtl $mdl $atv $sol $E0"
...
../bin/oGp
echo $newomemi $newomema $Gmax > "../data/output/oGp/data4plot.dat"
ogpfol="../img/oGp/"
...
for ii in {0..20}
  do
    ...
    {
        echo "$a $Dome $omeG $mG $wideomi $wideoma $mtl $mdl $atv $sol $E0"
        echo "# a Dome ome_g G omemi omema mtl mdl atv sol E0"
        echo "** WARNING: This file was automatically edited by $0."
        echo "** Do not edit this file manually until the process ends."
    } > $infile
...
{
    echo "$a $Dome $ome21 $G $omemi $omema $mtl $mdl $atv $sol $E0"
    echo "# a Dome ome_g G omemi omema mtl mdl atv sol E0"
} > $infile
