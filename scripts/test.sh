...
# Format expected:
# a Dome ome_g G omemi omema mtl mdl active sol E0
read -r a Dome ome_g G omemi omema mtl mdl active sol E0 < "$INPUT_FILE"
...
write_input() {
    ...
    local omema_val="3.5"
    {
        echo "$a $Dome $ome_g_val $G_val $omemi_val $omema_val $mtl $mdl $active $sol $E0"
        echo "# a Dome ome_g G omemi omema mtl mdl active sol E0"
